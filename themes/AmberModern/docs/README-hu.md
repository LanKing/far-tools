...
1. [Töltse le a témát](../AmberModernAndVtrEnabler.farconfig), és helyezze a fájlt a Far Manager könyvtárába.
...
A Far Manager a [BSD 3-Clause licenc](https://github.com/FarGroup/FarManager/blob/master/LICENSE) feltételei szerint terjeszthető.
